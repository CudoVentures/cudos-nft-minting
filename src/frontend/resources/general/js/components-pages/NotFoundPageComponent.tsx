...
export default class PageNotFoundComponent extends ContextPageComponent < Props > {
    ...
    static layout() {
        const MobXComponent = inject('appStore', 'alertStore', 'walletStore')(observer(PageNotFoundComponent));
        ...
        return (
            <div style = { { 'width': '1000px', 'height': '500px', 'margin': 'auto' } } className = { 'FlexSingleCenter' } >
                <LayoutBlock>
                    ...
                    <Actions>
                        <Button type = { Button.TYPE_ROUNDED } color = { Button.COLOR_SCHEME_1 } >button 01</Button>
                        <Button type = { Button.TYPE_ROUNDED } color = { Button.COLOR_SCHEME_2 } >button 02</Button>
                        <Button type = { Button.TYPE_TEXT_INLINE } color = { Button.COLOR_SCHEME_1 } >button 03</Button>
                        <Button type = { Button.TYPE_TEXT_INLINE } color = { Button.COLOR_SCHEME_2 } >button 04</Button>
                    </Actions>
